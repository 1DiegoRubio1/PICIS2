...
export function EditSystemUserModal({ open, onOpenChange, userId }: EditSystemUserModalProps) {
  const { systemUsers, createRequestWithAuthCheck, setActionSessionExpired, actionSessionExpired } = useApp();
  ...
  const executePendingAction = () => {
    if (pendingAction && pendingAction.type === 'editSystemUser') {
      const success = createRequestWithAuthCheck('editar entidad del sistema', pendingAction.data);
      if (success) {
  ...
  const handleSave = () => {
    ...
    const success = createRequestWithAuthCheck('editar entidad del sistema', requestData);
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Modifica los datos del usuario. Los cambios requieren aprobación.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="Analista de seguridad">Analista de seguridad</SelectItem>
              </SelectContent>
            </Select>
          </div>
